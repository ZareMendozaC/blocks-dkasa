...
<div class="my-container separador-avance" id="avance-proyecto">
    <section class="row no-padding no-margin">
            <div class="col-md-4 col-12 no-padding">
                <h2 class="subtitle-general" data-aos="fade-zoom-in" data-aos-duration="1500" data-aos-delay="200">Avance de obra</h2>
                <p class="subtitle-des" data-aos="fade-zoom-in" data-aos-duration="1500" data-aos-delay="200">Sé parte del día a día en el proceso de construcción de tu hogar. </p>

                    <div id="slider-nav-avance" class="center-btn slider-nav-avance" data-aos="fade-zoom-in" data-aos-duration="1500" data-aos-delay="200">
                        <?php
                            $num=1; 
                        ?>
                        <?php if($images) : ?>
            ...
            <div class="col-md-8 col-12 no-padding column-slider mrg-r-l">
                <div class="slider-obra slider-for-avance" data-aos="fade-zoom-in" data-aos-duration="1500" data-aos-delay="200">
                        <?php if($images) : ?>
                                <?php foreach ($images as $image): ?>
                ...
                <?php if($link_transparencia) : ?>
                    <a class="btn-transp" href="<?= $link_transparencia;?>" target="_blank" data-aos="fade-zoom-in" data-aos-duration="1500" data-aos-delay="200">Ver transparencia del proyecto</a>
                <?php endif;?>
            </div>
    </section>
</div>