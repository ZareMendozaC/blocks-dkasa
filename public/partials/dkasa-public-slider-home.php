                                ...
                                <div class="slider-container">
                                    <div class="columna-1">
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <div class="datos position-absolute" data-aos="fade-right" data-aos-duration="2000" data-aos-once="false">
                                                <div class="datos-principales" style="background-color:<?= $slide['backgroundColor'] ?>;">
                                                    <img src="<?= $slide['mediaUrl'] ?>" alt="" data-aos="fade-zoom-in" data-aos-delay="2000"  data-aos-once="false">
                                                    <p class="cifra" data-aos="fade-zoom-in" data-aos-delay="2000"  data-aos-once="false"><?= $slide['cifra'] ?></p>
                                                    <p class="descripcion" data-aos="fade-zoom-in" data-aos-delay="2000"  data-aos-once="false"><?= $slide['descripcion'] ?></p>
                                                    <div class="d-flex distrito" data-aos="fade-zoom-in" data-aos-delay="2000"  data-aos-once="false">
                                                ...
                                                <div class="enlace" data-aos="fade-zoom-in" data-aos-delay="2000"  data-aos-once="false">
