...
<div class="my-container separadores bg-simple">
    <section class="row no-padding no-margin">
            ...
            <h2 class="subtitle-general center-text" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="200"><?= $nombreproyecto;?></h2>
            <h2 class="subtitle-general center-text" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="200"><?= $frase;?></h2>
            </div>
    </section>
</div>