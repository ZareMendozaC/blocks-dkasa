			...
			<SectionContainer>
				{
					imagesArr && imagesArr.map((imageArr, i)=>(
						<Grid key={i} classEle="lia-section-repeater lia-card__item">
							<Item percentage={15} classEle="lia-gap-8">
								<ImageUploadRepeater
									variables={props}
									details ={{
										index: i,
							...
							<Item percentage={80}>
								<Text><strong>Característica:</strong></Text>
				...
				<Button onClick={addImage} variant="primary">{internationalizationText("+ Agregar")}</Button>
			</SectionContainer>
			<SectionContainer>
				<ImageUpload
									setAttr={setAttr}
